// GAS ライブラリ global `Gassma`(appsscript.json userSymbol)の ambient 宣言。
// gassma 本体 src/index.d.ts の declare namespace Gassma をそのままコピーし、末尾の export 文のみ除いたもの。
// 本体側の公開サーフェス変更時は再コピーで追従する。
